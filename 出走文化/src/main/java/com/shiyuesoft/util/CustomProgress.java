...
/**
 * Created by wangg on 2017/4/13.
 * 自定义 网络加载时，如果网络很慢显示的进度条
 */
public class CustomProgress extends Dialog {
     ...
     * @return
     */
    public  CustomProgress show(Context context, CharSequence message, boolean cancelable, OnCancelListener cancelListener) {
