 ...
 * 校园游记 全部
 */
public class NotesChildFragment1 extends Fragment implements SwipeRefreshLayout.OnRefreshListener, PTRecycleView.PTLoadMoreListener, View.OnClickListener, RecyclerViewAdapter.CommonListener {
    private View view;
    //显示游记的列表信息
    ...
    private String url = URLUtil.URL + URLUtil.path + "?action=travel_record";
    //评论的数据
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragmenrt_noteschild1, container, false);
        initView(view);
        return view;
    }
    /*
    ...
    * */
        ...
        okManager.asyncJsonStringByURL(URL, new OkManager.Func1() {
            ...
            public void onResponse(String result) throws JSONException {
                ...
                if (travelnotes != null) {
                    ...
                    datas.addAll(list);
                    adapter = new RecyclerViewAdapter(getActivity(), datas, R.layout.item_moment, NotesChildFragment1.this);
    ...
    public void ShareMsg(String id,String title,String content) {
        //http://www.briup.cn:8989/travel/transpond.php?rec_id=xx
        final String url=URLUtil.URL+"/travel/transpond.php?action=transpond&rec_id="+id;
        ShareSdkUtils.showShare(id,
                getActivity(), new ShareSdkUtils.WeixinCallBack() {
                    @Override
