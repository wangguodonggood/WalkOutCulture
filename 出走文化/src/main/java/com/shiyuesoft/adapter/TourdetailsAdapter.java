...
public class TourdetailsAdapter extends BaseAdapter{

    private Context context;
    private List<TourDetails.ReviewBean> datas;
    private ViewHolder holder;

    public TourdetailsAdapter(Context context, List<TourDetails.ReviewBean> datas) {
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        View view=null;
        TourDetails.ReviewBean reviewbean=null;
        if (convertView==null){
